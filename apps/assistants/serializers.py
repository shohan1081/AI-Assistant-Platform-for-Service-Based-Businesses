...
class AssistantSerializer(serializers.ModelSerializer):
    ...
    ui_banner_color = serializers.CharField(source='business.ui_banner_color', read_only=True)
    ui_border_radius = serializers.CharField(source='business.ui_border_radius', read_only=True)

    class Meta:
        model = Assistant
        fields = ['id', 'slug', 'business_name', 'is_active', 'ui_theme_color', 'ui_text_color', 'ui_banner_color', 'ui_border_radius', 'created_at', 'updated_at']
